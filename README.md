...
- Two-phase source reading: fetches PDFs, batch-scores candidates for relevance, selects the best sources, then runs full LLM extraction on the selected set only
